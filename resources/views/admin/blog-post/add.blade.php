        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-user">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{route('blog-post-add')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input name="post_title" value="{{old('post_title')}}" type="text" class="form-control @error('post_title')is-invalid @enderror">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="section_one_text" name="section_one_text" class="form-control @error('section_one_text')is-invalid @enderror" rows="6">{{old('section_one_text')}}</textarea>
...
{{--                                        <textarea id="section_two_text" name="section_two_text" class="form-control @error('section_two_text')is-invalid @enderror" rows="6">{{old('section_two_text')}}</textarea>--}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="cover_image_alt" value="{{old('cover_image_alt')}}" type="text" class="form-control @error('cover_image_alt')is-invalid @enderror">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="main_video_url" value="{{old('main_video_url')}}" type="text" class="form-control @error('main_video_url')is-invalid @enderror">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input name="main_quote" value="{{old('main_quote')}}" type="text" class="form-control @error('main_quote')is-invalid @enderror">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="main_quote_description" name="main_quote_description" class="form-control @error('main_quote_description')is-invalid @enderror" rows="6">{{old('main_quote_description')}}</textarea>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input name="sub_section_one_title" value="{{old('sub_section_one_title')}}" type="text" class="form-control @error('sub_section_one_title')is-invalid @enderror">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="sub_section_one_text" name="sub_section_one_text" class="form-control @error('sub_section_one_text')is-invalid @enderror" rows="6">{{old('sub_section_one_text')}}</textarea>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input name="sub_section_two_title" value="{{old('sub_section_two_title')}}" type="text" class="form-control @error('sub_section_two_title')is-invalid @enderror">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="sub_section_two_text" name="sub_section_two_text" class="form-control @error('sub_section_two_text')is-invalid @enderror" rows="6">{{old('sub_section_two_text')}}</textarea>
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input name="slug" value="{{old('slug')}}" type="text" class="form-control @error('slug')is-invalid @enderror">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input name="title_on_tab" value="{{old('title_on_tab')}}" type="text" class="form-control @error('title_on_tab')is-invalid @enderror">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input name="meta_keywords" value="{{old('meta_keywords')}}" type="text" class="form-control @error('meta_keywords')is-invalid @enderror">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input name="meta_description" value="{{old('meta_description')}}" type="text" class="form-control @error('meta_description')is-invalid @enderror">
