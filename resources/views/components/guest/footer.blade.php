<footer class="gap no-bottom one" style="background-image:url({{asset('theme/img/fotterbg.jpg')}})">
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="logo">
                    <a href="{{url('/')}}">
                        <img src="{{asset('common/images/logo-white-bg-transparent.png')}}" style="width: 100%">
                    </a>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="about-energix">
                    <h5>About</h5>
                    <p>Solar energy’s exceptional synergies with energy storage, electric vehicles and smart grids means the industry works on the frontline of technology and system change to deliver.</p>
                </div>
            </div>
{{--            <div class="col-lg-4 col-md-6">--}}
{{--                <div class="about-energix">--}}
        ...
        <div class="row contact-footer">
            <div class="col-xl-4 col-md-6">
                <div class="contact-info">
                    ...
                    <div>
{{--                        <h4>Phone No:</h4>--}}
{{--                        <a href="callto:01234525407"><p>01234 525 407  -  01234 525 407</p></a>--}}
                        <a href="callto:1300017832"><p>1300 017 832</p></a>
                        <a href="callto:0370036971"><p>03 7003 6971</p></a>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-md-6">
                <div class="contact-info">
                    ...
                    <div>
                        <p>Add18 Kimberly Rd, Dandenong South, VIC 3978</p>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-md-6">
                <div class="contact-info mb-0">
                    ...
                    <div>
{{--                        <h4>Email Address:</h4>--}}
                        <a href="mailto:info@solar-gridbox.com.au"><p>info@solar-gridbox.com.au</p></a>
        ...
        <div class="footer-bottom">
            <p>Ⓒ  Copyright SolarGridBox 2023. All Right Reserved.</p>
{{--            <ul>--}}
