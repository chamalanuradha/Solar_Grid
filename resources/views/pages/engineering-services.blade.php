...
@section('content')
    <section class="banner" style="background-image:url({{asset('theme/img/engineeringbg.jpg')}})">
        <div class="container">
    ...
    <section class="services gap ">
        <div class="container">
            <div class="heading">
                <p>We provide below engineering services to the commercial solar industry all over Australia.</p>
                <div class="line"></div>
                <h2>Smart & sustainable energy consumption</h2>
                <span>Powerful & intelligent energy storage solutions,helping you maximize your energy potential.</span>
            </div>
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <div class="use-energix three">
                        ...
                        <div>
                            <a href="#"><h2>Cordinate your PV system</h2></a>
                            <p>We coordinate with Australia wide DNSPs in order to get grid connection approval for your proposed PV system. Hand it over to us and experience below benefits</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="services-img">
                        <figure>
                            <img alt="img" src="{{asset('theme/img/engineering_services/1.jpg')}}">
                        </figure>
                    </div>
                </div>
            </div>
            <div class="row align-items-center mt-md-5 mt-2">
                <div class="col-lg-7">
                    <div class="services-img two">
                        <figure>
                            <img alt="img" src="{{asset('theme/img/engineering_services/2.jpg')}}">
                        </figure>
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="use-energix three">
                        ...
                        <div>
                            <a href="#"><h2>potential of your renewables</h2></a>
                            <p>leading renewable energy solutions provider that is sources are harnessed across the world. Present in 18 countries across Asia, Australia, Europe Africa and the Americas, Veztaz is powering.</p>
                        </div>
                    </div>
                </div>
            </div>
